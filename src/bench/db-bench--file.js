...
const oneWriteMini = async function () {
    ...
    while (timeUseMs < 150) {
        ...
        // // insert-single(many-time)
        // for (let i = 0; i < numLoop; i++) {
        //     await fs.appendFile(filePath, textWrite).catch(function (err) {
        //     // await fs.appendFile(filePath, 'data to append').catch(function (err) {
        //         console.error(err);
        //     });
        ...
        console.log('log::: timeUsed: ', timeUseMs);
        console.log(`log-on: -- [numConn=${numLoop} -- `);
